<!-- 当前班次护士配备 -->
<template>
  <el-container id="currentShiftNurses" class="currentShiftNurses">
    <!-- 顶部内容 -->
    <el-header>
      <div>
        <i class="iconBlue"></i>
    ...
    <!-- 中间内容部分 -->
    <el-main>
      <div v-if="showEchart" id="chartCurrentShiftNurses" class="chartCss"></div>
  ...
  methods: {
    ...
    init() {
      if (this.nurseDoctorBedList) {
        this.option.graphic.style.text = this.nurseDoctorBedList.bedNurseRatio
        this.option.series[0].data = [
          {
            name: '护士人数',
            value: this.nurseDoctorBedList.nurseCount
          },
          {
            name: '总床数',
