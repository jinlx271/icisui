...
(function () {
 ...
 if (Object.prototype.hasOwnProperty.call(s, p)) { t[p] = s[p] }
    ...
    var updateLink = function (editor, anchorElm, text, linkAttrs) {
      ...
      if (linkAttrs.linkType) {
        // linkAttrs['data-mce-linktype']
        anchorElm.setAttribute('data-mce-linktype', linkAttrs.linkType)
      }
    ...
    var unlinkSelection = function (editor) {
      var dom = editor.dom; var selection = editor.selection
    ...
    var unwrapOptions = function (data) {
      var cls = data.class; var href = data.href; var rel = data.rel; var target = data.target; var text = data.text; var title = data.title
      return filter({
        class: cls.getOrNull(),
        href: href,
        rel: rel.getOrNull(),
    ...
    var extractFromAnchor = function (editor, anchor) {
      ...
      var linkType = anchor ? Optional.from(dom.getAttrib(anchor, 'linkType') || dom.getAttrib(anchor, 'data-mce-linktype')) : Optional.none()
    ...
    var handleSubmit = function (editor, info) {
      return function (api) {
        ...
        var changedData = {
          ...
          linkType: getChangedValue('linkType'),
    ...
    var getInitialData = function (info, defaultTarget) {
      ...
      return {
        ...
        anchor: url,
        link: url,
        linkType: anchor.linkType.getOr(''),
