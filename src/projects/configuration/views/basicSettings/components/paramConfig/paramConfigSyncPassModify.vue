...
<template>
  <div class="syncPassModifyConfig">
    ...
    <div class="syncPassModifyConfigContent">
      <el-form ref="form" :model="encryptionInfo" label-width="8em" :rules="rules" align="left">
        <el-form-item label="启用" prop="esbFlag" class="line30" >
          <el-switch v-model="encryptionInfo.esbFlag" active-value="1" inactive-value="0" @change="changeValidate"></el-switch>
        </el-form-item>
        <el-form-item label="请求地址" v-if="encryptionInfo.esbFlag=='1'" prop="url">
          <el-input v-model="encryptionInfo.url" placeholder="请输入" :maxlength="200" ></el-input>
        </el-form-item>
        <el-form-item label="appId" v-if="encryptionInfo.esbFlag=='1'" prop="appId">
          <el-input v-model="encryptionInfo.appId" placeholder="请输入" :maxlength="200" ></el-input>
        </el-form-item>
        <el-form-item label="secretKey" v-if="encryptionInfo.esbFlag=='1'" prop="secretKey">
          <el-input v-model="encryptionInfo.secretKey" placeholder="请输入" :maxlength="200" ></el-input>
        </el-form-item>
      </el-form>
    </div>
  </div>
