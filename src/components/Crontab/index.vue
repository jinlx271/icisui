      ...
      <div class="popup-result">
        ...
        <table>
          ...
          <tbody>
            ...
            <td>
              <el-input type="text" v-model="crontabValueStringCopy" placeholder="请输入" disabled></el-input>
            </td>
          </tbody>
        </table>
      </div>
      <CrontabResult :ex="crontabValueString" v-if="shouldHide('result')"></CrontabResult>
      <!-- <div class="pop_btn">
  ...
  methods: {
    change() {
      return new Promise(function (resolve, reject) {
        this.$emit("fill", this.crontabValueStringCopy);
        resolve(this.crontabValueStringCopy)
      }.bind(this))
    },
    shouldHide(key) {
