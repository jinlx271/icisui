...
export default {
  ...
  render(h) {
    ...
    const TEMPLATE_MAP = {
      ...
      pager: <pager pageSize={ this.pageSize } total={this.total} currentPage={ this.internalCurrentPage } pageCount={ this.internalPageCount } pagerCount={ this.pagerCount } on-change={ this.handleCurrentChange } disabled={ this.disabled }></pager>,
      next: <next></next>,
